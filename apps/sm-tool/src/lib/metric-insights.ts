...
const DEFINITIONS: Record<string, MetricInsightDefinition> = {
  ...
  "Avg Cycle Time": { label: "Avg Cycle Time", unit: "working days", direction: "lower", meaning: "Legacy label for the existing implementation-duration average.", calculation: "Existing flowTiming cycle-time average using Monday-Friday working days." },
...
const DEFINITION_DETAILS: Record<string, Pick<MetricInsightDefinition, "metricId" | "collection" | "source" | "unavailable" | "teamDetail" | "diagnosticDetail">> = {
  ...
  "Avg Cycle Time": { metricId: "avg-cycle-time-legacy", collection: "Local imported issue history and status-transition snapshot.", source: "Local flowTiming snapshot", unavailable: "Unavailable · no valid legacy Cycle Time value exists for the selected period.", teamDetail: "Compatibility label only: this existing value is now presented as Implementation Time.", diagnosticDetail: "Legacy Cycle Time maps to current Implementation Time; the formula is unchanged." },
  ...
  "Active Time": { metricId: "active-time-legacy", collection: "Local imported issue history and configured active statuses.", source: "Local flowTiming snapshot", unavailable: "Unavailable · no valid legacy Active Time value exists for the selected period.", teamDetail: "Compatibility diagnostic only: Active Time is the legacy name for current Cycle Time.", diagnosticDetail: "Legacy Active Time = Active + Implementing; it is not added to other metrics." },
  "Cycle Time": { metricId: "cycle-time", collection: "Local imported issue history and configured active and implementing statuses.", source: "Local flowTiming snapshot", unavailable: "Unavailable · no valid Cycle Time value exists for the selected period.", teamDetail: "Shorter Cycle Time is generally better.", diagnosticDetail: "Current Cycle Time uses the former Active Time definition: Active + Implementing." },
  ...
  "Implementation Time": { metricId: "implementation-time", collection: "Local imported issue history and configured implementing statuses.", source: "Local flowTiming snapshot", unavailable: "Unavailable · no valid Implementation Time value exists for the selected period.", teamDetail: "Shorter implementation flow is generally better.", diagnosticDetail: "Uses the approved existing implementation-flow contract when available; no fallback formula is introduced." },
  "Waiting Time %": { metricId: "waiting-time-percent", collection: "Local status-transition and flow snapshot.", source: "Local flow health snapshot", unavailable: "Unavailable · waiting-time coverage is not available for this period.", teamDetail: "Lower waiting share generally means smoother flow.", diagnosticDetail: "Uses the existing waiting-time share only when its approved contract is available." },
};
...
Object.assign(DEFINITIONS, {
  ...
  "Active Time": { label: "Active Time", unit: "working days", direction: "lower", meaning: "Flow time after Funnel until Done in the active delivery flow.", calculation: "Existing flowTiming Active Time average using Monday-Friday working days." },
  "Cycle Time": { label: "Cycle Time", unit: "working days", direction: "lower", meaning: "Working days from the configured active flow through Active and Implementing to Done.", calculation: "Existing flowTiming Active Time average using Monday-Friday working days; the legacy field remains unchanged." },
  ...
  "Lead Time": { label: "Lead Time", unit: "working days", direction: "lower", meaning: "Total flow time from Funnel or project entry until Done.", calculation: "Existing flowTiming Lead Time average using Monday-Friday working days." },
  "Implementation Time": { label: "Implementation Time", unit: "working days", direction: "lower", meaning: "Time spent in the configured implementation flow before Done.", calculation: "Existing flowTiming Cycle Time average using Monday-Friday working days; the legacy field remains unchanged." },
  "Waiting Time %": { label: "Waiting Time %", unit: "%", direction: "lower", meaning: "Share of measured flow time spent waiting.", calculation: "Existing waiting-time share when available; it is not inferred from missing data." },
});

export function getMetricInsightDefinition(label: string): MetricInsightDefinition {
  const definition = DEFINITIONS[label];
  const details = DEFINITION_DETAILS[label];
