...
const DEFINITION_DETAILS: Record<string, Pick<MetricInsightDefinition, "metricId" | "collection" | "source" | "unavailable" | "teamDetail" | "diagnosticDetail">> = {
  ...
  "Avg Cycle Time": { metricId: "avg-cycle-time", collection: "Local imported issue history and status-transition snapshot.", source: "Local flowTiming snapshot", unavailable: "Unavailable · no valid Cycle Time average exists for the selected period.", teamDetail: "Shorter completion time is generally better.", diagnosticDetail: "Existing flowTiming sample and Monday-Friday working-day calculation." },
  ...
  "Active Time": { metricId: "active-time", collection: "Local imported issue history and configured active statuses.", source: "Local flowTiming snapshot", unavailable: "Unavailable · no valid Active Time value exists for the selected period.", teamDetail: "Shorter active flow is generally better.", diagnosticDetail: "Separate existing flow measure; it is not added to other metrics." },
  "Cycle Time": { metricId: "cycle-time", collection: "Local imported issue history and configured implementing statuses.", source: "Local flowTiming snapshot", unavailable: "Unavailable · no valid Cycle Time value exists for the selected period.", teamDetail: "Shorter implementation flow is generally better.", diagnosticDetail: "Existing Cycle Time metric; Time in Status remains diagnostic and non-additive." },
...
Object.assign(DEFINITIONS, {
  ...
  "Cycle Time": { label: "Cycle Time", unit: "working days", direction: "lower", meaning: "Implementation time from the configured first hands-on state until Done.", calculation: "Existing flowTiming Cycle Time average using Monday-Friday working days." },
  ...
  "Implementation Time": { label: "Implementation Time", unit: "working days", direction: "lower", meaning: "Time spent in the configured implementation flow before Done.", calculation: "Existing implementation-flow metric when its approved contract is available." },
