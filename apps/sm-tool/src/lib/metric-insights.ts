...
const DEFINITION_DETAILS: Record<string, Pick<MetricInsightDefinition, "metricId" | "collection" | "source" | "unavailable" | "teamDetail" | "diagnosticDetail" | "compatibilityNote">> = {
  ...
  "SLE Compliance": { metricId: "sle-compliance", collection: "Local open-work and SLE snapshots.", source: "Local SLE health snapshot", unavailable: "Unavailable · the SLE threshold or eligible open-work population is unavailable.", teamDetail: "Share of currently open work within the team’s existing SLE P85 expectation.", diagnosticDetail: "Shows within-SLE and over-threshold counts for eligible open work; it is not completed-work compliance." },
  ...
  "Open Bug Ratio": { metricId: "open-bug-ratio", collection: "Local imported issue types and open-item snapshot.", source: "Local issue-type snapshot", unavailable: "Unavailable · no valid open-WIP denominator exists.", teamDetail: "Lower generally means less bug pressure in in-flight work.", diagnosticDetail: "Open bug items divided by open WIP items; configured bug mapping and unknown handling remain authoritative." },
  "WIP Bug Ratio": { metricId: "wip-bug-ratio", collection: "Local imported issue types and open-item snapshot.", source: "Local issue-type snapshot", unavailable: "Unavailable · no valid open-item denominator exists.", teamDetail: "Lower generally means less bug pressure in in-flight work.", diagnosticDetail: "Compatibility label for the existing open-item ratio; use Open Bug Ratio in new UI." },
  "Flow Efficiency": { metricId: "flow-efficiency", collection: "Local flowTiming and Time in Status snapshots.", source: "Local flow health snapshot", unavailable: "Unavailable · active or queue time is missing, conflicting, or has a zero denominator.", teamDetail: "Higher means more observed flow time was active rather than waiting.", diagnosticDetail: "Formula: active time ÷ (active time + queue time) × 100. Time in Status remains diagnostic and non-additive." },
  ...
  "Forecast P85": { metricId: "forecast-p85", collection: "Local throughput and open-backlog forecast snapshot.", source: "Local forecast snapshot", unavailable: "Unavailable · forecast prerequisites are incomplete.", teamDetail: "Estimated time to finish the currently open backlog at approximately 85% Monte Carlo confidence.", diagnosticDetail: "Backlog-completion forecast, not Cycle Time SLE/P85 and not a promise for one item. The existing helper reports calendar days." },
...
Object.assign(DEFINITIONS, {
  ...
  "SLE Compliance": { label: "SLE Compliance", unit: "%", direction: "higher", meaning: "Share of currently open work that is within the team’s existing SLE P85 delivery expectation.", calculation: "Eligible open WIP within SLE ÷ eligible open WIP × 100; over-threshold open items are shown separately." },
  ...
  "Open Bug Ratio": { label: "Open Bug Ratio", unit: "%", direction: "lower", meaning: "Share of currently open work classified as bugs.", calculation: "Open bug items ÷ open WIP items × 100." },
  "WIP Bug Ratio": { label: "WIP Bug Ratio", unit: "%", direction: "lower", meaning: "Compatibility label for Open Bug Ratio.", calculation: "Open bug items ÷ open WIP items × 100." },
  "Flow Efficiency": { label: "Flow Efficiency", unit: "%", direction: "higher", meaning: "Share of observed flow time spent actively worked rather than waiting.", calculation: "Active time ÷ (active time + queue time) × 100." },
  ...
  "Forecast P85": { label: "Forecast P85", unit: "calendar days", direction: "lower", meaning: "Estimated time to finish the currently open backlog at approximately 85% Monte Carlo confidence.", calculation: "Existing Monte Carlo backlog-completion forecast using recent daily throughput; not Cycle Time SLE/P85 and not a single-item promise." },
