...
import { buildExecutiveFlowSummary } from "../apps/sm-tool/src/lib/metric-consistency";

describe("buildExecutiveFlowSummary", () => {
  it("calculates one deterministic flow summary for both Team and Scrum Master views", () => {
